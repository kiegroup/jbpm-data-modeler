...
public class MultipleActivitiesFoundView_MultipleActivitiesFoundViewBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView>, org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView.MultipleActivitiesFoundViewBinder {


  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView owner) {
   ...
   */
  class Widgets {
    private final org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView owner;


    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.onClickCancelButton(event);
      }
    };

    public Widgets(final org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView owner) {
      this.owner = owner;
     ...
     */
    private org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView_MultipleActivitiesFoundViewBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView_MultipleActivitiesFoundViewBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView_MultipleActivitiesFoundViewBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView_MultipleActivitiesFoundViewBinderImpl_GenBundle) GWT.create(org.uberfire.client.workbench.widgets.popups.activities.multiple.MultipleActivitiesFoundView_MultipleActivitiesFoundViewBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private org.uberfire.client.resources.i18n.CoreConstants i18n;
    ...
    private org.uberfire.client.resources.i18n.CoreConstants build_i18n() {
      // Creation section.
      i18n = (org.uberfire.client.resources.i18n.CoreConstants) GWT.create(org.uberfire.client.resources.i18n.CoreConstants.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.VerticalPanel build_f_VerticalPanel1() {
      ...
      f_VerticalPanel1.add(get_activitiesList());
      f_VerticalPanel1.add(get_cancelButton());
    ...
    private com.google.gwt.user.client.ui.Label build_f_Label4() {
      ...
      // Setup section.
      f_Label4.setText("" + get_i18n().multipleMatchingActivitiesFound() + "");
    ...
    /**
     * Getter for activitiesList called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.VerticalPanel get_activitiesList() {
      return build_activitiesList();
    }
    private com.google.gwt.user.client.ui.VerticalPanel build_activitiesList() {
      // Creation section.
      final com.google.gwt.user.client.ui.VerticalPanel activitiesList = (com.google.gwt.user.client.ui.VerticalPanel) GWT.create(com.google.gwt.user.client.ui.VerticalPanel.class);
      // Setup section.


      owner.activitiesList = activitiesList;
     ...
     */
    private com.github.gwtbootstrap.client.ui.Button get_cancelButton() {
      return build_cancelButton();
    }
    private com.github.gwtbootstrap.client.ui.Button build_cancelButton() {
      // Creation section.
      final com.github.gwtbootstrap.client.ui.Button cancelButton = (com.github.gwtbootstrap.client.ui.Button) GWT.create(com.github.gwtbootstrap.client.ui.Button.class);
      // Setup section.
      cancelButton.setText("" + get_i18n().cancel() + "");
